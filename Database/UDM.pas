...
type
  TDM = class(TDataModule)
    ...
    TBL_MEMBROSDATA_BATISMO: TStringField;
    TBL_MEMBROSDATA_ADMISSAO: TStringField;
    TBL_MEMBROSPAIS_ORIGEM: TStringField;
    TBL_MEMBROSTELEFONE_PAIS_ORIGEM: TStringField;
    TBL_MEMBROSDATA_CASAMENTO: TStringField;
    TBL_MEMBROSATIVO: TStringField;
    TBL_MEMBROSIGREJA_BATISMO: TStringField;
    TBL_MEMBROSDATA_CONSAGRACAO: TStringField;
