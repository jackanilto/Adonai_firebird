...
begin
  if ( FileExists('imagem') and (dm.frxCarteirinha.FindComponent('componente')<> nil ) ) then
  begin
  DM.frxCarteirinha(DM.frxCarteirinha.FindComponent('componente'))..LoadFromFile('imagem');
